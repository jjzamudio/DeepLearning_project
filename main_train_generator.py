    ...
    for i, data in enumerate(dataloader, 0):
       ...
       # train with real
        ...
        for iter in range(opt.giter):
            ...
            optimizerG.step()
    #G train a variable number of times for each iteration of D whenever D(G(z)) fell below a certain threshold to try to speed up training and make G more stable. 
